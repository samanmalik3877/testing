       ...
       <View>
        <SafeAreaView>
            ...
            {/* <View style={styles.parentHr}>
                {
                    this.props.title=="Pizzas" &&  this.state.expanded &&
                    <View>
                 <TouchableOpacity style={styles.row} onPress={()=>this.toggleExpand()}>
                <Text style={[styles.titlea]}>abc</Text>
                <Icon name={this.state.expanded ? 'keyboard-arrow-down' : 'keyboard-arrow-up'} size={30} color={Colors.DARKGRAY}  />
            </TouchableOpacity>
                    </View>
                }
                    ...
                    renderItem={({item, index}) => 
                        <View>
                            <TouchableOpacity style={[styles.childRow, styles.button, item.value ? styles.btnActive : styles.btnInActive]} onPress={()=>this.onClick(index)}>
                                ...
                                <Icon name={'check-circle'} size={24} color={ item.value ? Colors.Pink :  Colors.LIGHTGRAY } />
                            </TouchableOpacity>
